...
.if cputype = 1
    .PC02               ; Turn on 65c02 support in "ca65".
    .macro  end_of_test
        stp
    .endmacro
.else
...
NEXT2:  inc N2    ; [6] see text
        ...
        sta ERROR
SUCCESS: jmp SUCCESS ; on test passing, ERROR will contain 0 (set above).
DONE:   end_of_test  ; on test failing, DONE is reached. ERROR will be 1.
