...
; example linker config (functional.cfg):
;  MEMORY {
...
;                is shifted out
; BPB: the shift tests starting at line ~4180 where "ldx #3" is used
;      were changed to "ldx #5" in Klaus' test. However, with 5
;      the tests don't pass, but with 3 they do. Need to look into this.
